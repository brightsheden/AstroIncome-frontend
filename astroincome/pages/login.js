    ...
    <div className='mainBackground h-screen' >
      ...
      <div className='p-5'>
        ...
        <form className='bg-white mt-4 p-5  w-50'>
          ...
          <h3 className='text-purplr-500 text-2xl'>User Login</h3>
          </div>
          <div className='block'>
          ...
          focus:outline-none focus:bg-white focus:border-purple-500' type='text' placeholder='enter your mail' id='inline-full-name'></input>
          ...
          <div className='  w-full'>
          <input className='bg-grey-200 appearance-none border-2 border-grey-200 rounded w-full py-2 px-4 text-grey-700 leading-tight
          focus:outline-none focus:bg-white focus:border-purple-500' type='text' placeholder='enter your mail' id='inline-password' />
